...
with coluna1:
    ...
    with st.form(key="formulario"):
        ...
        bins_income = [0, 0.15, 3, 4.5, 6, np.inf]
        ...
        botao_previsao = st.form_submit_button("Prever preço do imóvel")
...
with coluna2:
    ...
    tooltip = {
        "html": "<b>Contado:</b'> {name}",
        "style": {"backgroundColor":"steetblue", "color":"white", "fontsize":"10px"}
    }
