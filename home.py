...
longitude = st.number_input("Longitude", value=-122.22)
...
median_income = st.slider("Renda média (múltiplos de 10 mil dolares)", min_value=0.5, max_value=15.0, value=4.5, step=0.5)
